...
class Mail extends Base {
  ...
  **/
  public function contactform($senderName, $senderEmail, $senderSubject, $senderMessage) {
    ...
    $aData['email'] = $this->setting->getValue('website_email', 'noreply@hppcoin.com');
  ...
  public function sendMail($template, $aData, $throttle=false) {
    ...
    $senderEmail = $this->setting->getValue('website_email', 'noreply@hppcoin.com');
    $senderName = $this->setting->getValue('website_name', 'noreply@hppcoin.com');
